...
<div id="header">
  <div class="header_inner">
    <div class="logo">
        ...
        <%--<div class="index_topad" id="playLogo" style="">
            <a href="/html/activity/1472179566.html" target="_blank">
              <img src="/businessPlatform/images/logo.jpg">
            </a>
        </div>--%>
		<a href="/businessPlatform/" class="trackref logoleft">
          <img src="/businessPlatform/images/logo.png">
		</a>
		<div class="logo-text">
			<img src="/businessPlatform/images/logo_word.jpg">
		</div>
		</div>
    <div class="index_promo"></div>
    <div class="search">
      <form action="/businessPlatform/data/product/selectProdListByKey" id="searchForm" name="query" method="GET">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="/businessPlatform/data/cart/selectCartList" class="t" rel="nofollow">我的购物车</a><b id="cartNum">${sessionScope.cartTotal}</b>
