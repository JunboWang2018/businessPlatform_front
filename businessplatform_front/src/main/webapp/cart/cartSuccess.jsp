...
<head>
	...
	<script type="text/javascript">
		...
		function toCartPage() {
			window.location.href = getRootPath() + "/data/cart/selectCartList";
		}
	</script>
</head>
<body>
	...
	<div class="cartMain">
		<div class="cartThead" style="margin: 50px 0px 50px 50px;">
			...
			<div class="cartJsuan">
				<input type="button" class="goshop" onclick="back()" value="返回"/>
				<input type="button" class="jiesuan youxuan" onclick="toCartPage()" value="去购物车结算"/>
			</div>
		</div>
